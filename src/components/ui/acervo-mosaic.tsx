...
export const AcervoMosaicCard = ({ images }: { images: any[] }) => {
  ...
  // Função para dividir as imagens em grupos de 5 (3 + 2)
  const groupImages = () => {
    const groups = [];
            ...
            {group.slice(0, 3).map((image: any) => (
              ...
              >
                <div className="h-[500px] w-auto">
                  <Image
                    src={image.thumbnail}
                    alt={image.alt || "Imagem do acervo"}
        ...
        {selectedImage && (
          ...
          >
            <motion.img
              ...
              alt={selectedImage.alt || "Imagem do acervo"}
